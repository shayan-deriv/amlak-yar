...
<body>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4">
            <div class="row">
              ...
              <div class="col-md-12 ">
                <h4 class="text-center " style="color: #1d9742;font-size: x-large;padding: 20px;">املاک فرهنگیان سبز</h4>
              </div>
            </div>
                ...
                <form id="myForm" action="{{ route('login') }}" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" name="password"
                      class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" autocomplete="off" focus>
                  ...
                  <button type="button" onclick="doSubmit()"
                    class="btn btn-primary btn-flat m-b-30 m-t-30">ورود</button>
                </form>
              </div>
            </div>
          </div>
  ...
  <script>
    const toEnglishDigits = value => {
      ...
      return value.replace(/[۰-۹]/g, w => w.charCodeAt(0) - charCodeZeroFa).replace(/[٠-٩]/g, w => w.charCodeAt(0) -
        charCodeZeroAr)
    }
